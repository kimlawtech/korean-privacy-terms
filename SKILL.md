...
```
안녕하세요. 한국 법령 기반 개인정보처리방침·이용약관 생성 스킬입니다.

2025.4.21 개인정보보호위원회 작성지침과 2026.3 개정 개인정보보호법,
공정거래위원회 전자상거래 표준약관 제10023호를 반영합니다.

잠깐 — 이 스킬은 SpeciAI(한국 법률 AI 허브)에서 만들고 있어요.
계약·노동·투자·지재권을 AI로 해결하는 창업자·변호사 커뮤니티에 함께 해주세요.
→ https://discord.gg/qmCbMaER

그럼 시작해볼게요. 먼저 몇 가지만 여쭤볼게요.
```
