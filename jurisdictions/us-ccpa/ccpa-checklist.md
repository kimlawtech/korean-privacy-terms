# US CCPA/CPRA + State Privacy Laws Checklist (2026)

California Consumer Privacy Act (CCPA, 2018) as amended by the California Privacy Rights Act (CPRA, 2020/2023). 2026-01-01 updated regulations by CPPA (California Privacy Protection Agency).
...
### Privacy Policy에 반드시 명시

1. **Notice at Collection** — 수집 시점 공지
2. **Categories of PI collected** — 지난 12개월간 수집한 정보 카테고리
3. **Categories of sources** — 수집 출처 (consumer / device / third party)
4. **Business/commercial purposes** — 이용 목적
5. **Categories of third parties** — 제공·공유·판매한 수신자 카테고리
6. **Sale/Share disclosure** — 판매·공유 여부
7. **Sensitive PI (SPI) disclosure** — 민감정보 수집 여부 및 목적
8. **Retention period** — 각 카테고리별 보유 기간 또는 기준
9. **Consumer rights list** — 7개 권리 상세
10. **How to exercise rights** — 요청 방법 (최소 2개 채널: toll-free + online)
11. **"Do Not Sell or Share My Personal Information" 링크** — 홈페이지에 명시
12. **"Limit the Use of My Sensitive Personal Information" 링크** — SPI 처리 시
13. **Authorized agent 지정 방법**
14. **Non-discrimination 조항**
15. **Last updated date** — 12개월마다 갱신 필수

## 7대 Consumer Rights (CCPA/CPRA)

1. **Right to Know** (§1798.110, §1798.115) — 무엇을 수집·판매·공유했는지 알 권리
2. **Right to Delete** (§1798.105) — 개인정보 삭제 요구
3. **Right to Correct** (§1798.106, CPRA 신설) — 부정확한 정보 수정 요구
4. **Right to Opt-Out of Sale/Share** (§1798.120) — 판매·공유 거부
5. **Right to Limit Use of Sensitive PI** (§1798.121, CPRA 신설) — 민감정보 사용 제한
6. **Right to Data Portability** (§1798.130) — 데이터 이동
7. **Right to Non-Discrimination** (§1798.125) — 권리 행사 시 차별 금지
...
소비자가 "Limit the Use of My Sensitive Personal Information"을 행사하면 SPI를 **다음 용도로만** 사용 가능:
- 요청한 상품·서비스 제공에 필요한 범위
- 보안·사기 방지
- 단기 거래 품질 검증
- 고용자 책임 수행
- 법적 의무 준수

## 2026-01-01 발효 신규 규정 (CPPA)
...
- **Sale**: 금전적 대가 수반 (CCPA 2018)
- **Share**: 크로스컨텍스트 행태광고 목적 공유 (CPRA 신설, 금전 대가 없어도 해당)

→ Google Analytics·Meta Pixel 같은 **추적 도구도 "공유"로 분류**될 수 있음. 강제 Opt-Out 링크 필수.
...
1. **홈페이지에 링크** — Footer 등 눈에 띄는 위치
2. **Opt-Out 방식**: 
   - Clear button/link (간단 텍스트)
   - GPC (Global Privacy Control) 브라우저 신호 준수 (CPRA 의무)
3. **별도 "Limit SPI" 링크** — SPI 처리 시
4. **인증된 에이전트 수용** — 소비자가 대리인 지정 가능
...
- "Right to Know / Delete / Correct / Opt-Out / Limit / Portability / Non-Discrimination"
- "Do Not Sell or Share"
- "Sensitive Personal Information"
- "Authorized agent"
- "Last updated"
- "California Consumer Privacy Act" or "CCPA"
- "45 days" or "45-day response"

## 작성 팁

- **캘리포니아 거주자** 대상이면 반드시 CCPA 준수 (한국 법인도 적용)
- 회사가 소규모라도 **100K 레코드 넘으면** 적용
- "우리는 판매 안 합니다"라고 명시해도 **광고 추적하면 Share로 걸림**
- **GPC 신호** 자동 준수해야 (단순 선언만으로 부족)
- 12개월마다 Privacy Policy 재검토 및 Last updated 갱신
